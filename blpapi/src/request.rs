use crate::{
    core::{
        ...
        BLPAPI_DEFAULT_FIELD_SEARCH_REQUEST_DATA_REQUEST, BLPAPI_DEFAULT_GOVT_LIST_DATA_REQUEST,
        BLPAPI_DEFAULT_HISTORICAL_DATA_REQUEST, BLPAPI_DEFAULT_INSTRUMENT_LIST_REQUEST,
...
impl From<RequestTypes> for &str {
    fn from(arg: RequestTypes) -> Self {
        match arg {
            ...
            RequestTypes::GovtList => BLPAPI_DEFAULT_GOVT_LIST_DATA_REQUEST,
